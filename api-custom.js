/**
 * Created by vandana on 11/5/16.
 */
var url = require('url');
var errorCodes = require('../errorCodes/command');
var questions = require('../questions/aboutq-custom');
var apiq = require('../questions/apiq-custom');
...
function processRequest(options, cb) {
    var endPointDeatils=options.endPointDeatils;

   // console.log(endPointDeatils);
    ...
    if (!hostMatch && createNew) {
        async.series({
                swaggerInfo: function (callback) {
                    getSwaggerInfo(swaggerSpec,endPointDeatils, callback);
                },
...
var getSwaggerInfo = function(swaggerSpec,endPointDeatils,callback){
    //questions.infoQ(null, function(answers) {
        var answers={};
        answers.title=endPointDeatils.name;
        answers.description=endPointDeatils.description;
        answers.termsOfService="DBS terms";
        answers.version=endPointDeatils.version;
        answers.contactName="DBS Customer Support";
        answers.contactUrl="https://dbs.support.com";
        answers.contactEmail="https://dbs.customerSupport.com";
        answers.licenseName="DBS Std License";
        answers.licenseUrl="https://dbs.license.com";
